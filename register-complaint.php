                ...
                <form class="min-w-full p-10 bg-white rounded-lg shadow-xl xl:px-10" method="post" action="">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-3">
                        ...
                        <div class="grid content-center ">
                            <label class="block font-semibold text-gray-800 text-md " for="myCheck">If Not Asset Related
                                Kindly Enable Tick </label>
                            <input class="" type="checkbox" id="myCheck" onclick="myFunction()">


                        </div>

                        <div class=''>
                            <label for="place" class="block my-3 font-semibold text-gray-800 text-md ">Asset
                            </label>
                        ...
                        <div class=''>
                            <label for="branchcode" class="block gap-5 my-3 font-semibold text-gray-800 text-md">Warranty ExpiryDate
                            </label>
                    ...
                    <div class="grid grid-cols-3 place-content-center">
                        <div>
                            <label for="branchcode"
                                class="block w-full my-3 font-semibold text-gray-800 text-md">Complaint Related Doc(if
                                any)
                            </label>
                            <span class="sr-only">Choose File</span>
                            <input type="file"
                                class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-amber-400 file:text-amber-50 " />
                    ...
                    <div class="grid place-items-center">
                        ...
                        <div class="">
                            <button type="submit" name="submit"
                                class="px-4 py-2 mt-6 mb-3 font-sans text-lg font-semibold tracking-wide text-white rounded-lg bg-amber-400 hover:bg-amber-500">Submit</button>
                        </div>
                    </div>
