...
<body class = "body bg-white dark:bg-[#0F172A]">
        ...
        <div class = "flex items-center justify-center flex-none h-full text-center">
                ...
                <div class = "flex items-center px-3 space-x-3">
                    ...
                    <div class="flex w-8 h-8 ">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcShta_GXR2xdnsxSzj_GTcJHcNykjVKrCBrZ9qouUl0usuJWG2Rpr_PbTDu3sA9auNUH64&usqp=CAU" alt="profile" class="object-cover rounded-full shadow" />
                    </div>
                    </div>

                    <div class = "hidden text-sm text-black md:block md:text-md dark:text-white">John Doe</div>
                </div>
    ...
    <aside class = "w-60 -translate-x-48 fixed transition transform ease-in-out duration-1000 z-50 flex h-screen bg-[#1E293B] ">
        ...
        <div class = "max-toolbar translate-x-24 scale-x-0 w-full -right-6 transition transform ease-in duration-300 flex items-center justify-between border-4 border-white dark:border-[#0F172A] bg-[#1E293B]  absolute top-2 rounded-full h-12">
            ...
            <div  class = "flex items-center py-1 pl-10 pr-2 space-x-3 text-white rounded-full group bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-indigo-500 via-purple-500 to-purple-500 ">
